...
const { fran, jasen , tanaka} = {
    fran: "witch",
    jasen: "skeleton",
    tanaka: "vampire",
};
console.log({fran,jasen,tanaka});
...
function result(data) {
    return `${data.musician}, is a ${data.country} singer/songwriter and ${data.genre} . The musician sings indie-pop and their greatest hit is ${data.hit}`
}
